    ...
    <div className='super_div'>
      <div className='main_div'>
        ...
        <div style = {{width: '320px',height: '250px', position:'relative', margin:'1rem 0'}}>
          {
            product&&product.photo&&<img style={{border: '.5px solid rgba(0,0,0,.5)',opacity:(Loading&&isLoading)?'.3':'1', borderRadius:'10px', display:'flex',justifyContent:'center'}} className='product_img' src = { `/public/img/users/${product&&product.photo}` } />
          }
        </div>
