...
export const UPDATE_MY_NAME_REQUEST = 'UPDATE_MY_NAME_REQUEST';
export const UPDATE_MY_NAME_SUCCESS = 'UPDATE_MY_NAME_SUCCESS';
export const UPDATE_MY_NAME_FAIL = 'UPDATE_MY_NAME_FAIL';
